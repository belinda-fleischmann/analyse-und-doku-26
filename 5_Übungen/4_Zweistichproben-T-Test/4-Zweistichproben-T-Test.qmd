...
Beschreiben Sie die Patient:innen- und Therapiebedingungsgruppen. Erläutern Sie die Designmatrixform des Zweistichproben-T-Test-Modells 
und vergleichen Sie diese mit der Designmatrixform des Einstichproben-T-Test-Modells aus Übungsblatt 3. Erläutern Sie 
insbesondere, wie sich der Kontrastgewichtsvektor $c = (1, -1)^T$ auf die Teststatistik auswirkt. Dokumentieren Sie Ihre Datenanalyse in Form kommentierten **R** Codes zur Lösung von Programmieraufgabe 1.
