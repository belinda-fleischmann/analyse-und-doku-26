...
*Online Studiengruppe* ($n = 32$) und einer *Face-To-Face Studiengruppe* ($n = 30$) 
...
n_1        <- 32                                                               # Anzahl Patient:innen Online Gruppe
n_2        <- 30                                                               # Anzahl Patient:innen Face-to-Face Gruppe
...
den Wert der Zweistichproben-T-Teststatistik, sowie den korrespondierenden p-Wert. 
...
Stichprobengröße von $n_1 = 32$ und $n_2 = 30$ und einem kritischen Wert, der 
...
# Ausgabe
cat("                 Betaparameterschätzer (Online, F2F): ", beta_hat,
...
\noindent 2. Visualisieren Sie die entsprechenden Gruppenmittelwerte als Linienplots mit Fehlerbalken analog zu Figure 2 in @wagner2014. Visualisieren außerdem die Post-Pre-Differenz Werte als gruppenspezifische *Violinplots* mithilfe des *R* Pakets `vioplot`. Die Abbildung sollte in etwa aussehen wie @fig-abbildung.
...
Stellen Sie die Ausgangsfrage von  @wagner2014 dar und erläutern Sie kurz mögliche Vor- und Nachteile der *Online* und der *Face-to-Face* Therapieform wie von @wagner2014 diskutiert. 

### Methoden {-}

Beschreiben Sie die Patient:innen- und Therapiebedingungsgruppen. Erläutern Sie verbal die Designmatrixform des Zweistichproben-T-Test-Modells und vergleichen Sie diese mit der Designmatrixform des Einstichproben-T-Test-Modells aus Übungsblatt 3. Erläutern Sie insbesondere, wie sich der Kontrastgewichtsvektor $c = (1, -1)^T$ auf die Teststatistik auswirkt. Dokumentieren Sie Ihre Datenanalyse in Form kommentierten **R** Codes zur Lösung von Programmieraufgabe 1.
