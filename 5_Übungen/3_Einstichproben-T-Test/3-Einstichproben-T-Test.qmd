...
*Zweistichproben-T-Test bei abhängigen Stichproben* bezeichnet. Zum Zwecke dieser Übung 
fokussieren wir auf die *Face-to-Face Studiengruppe* ($n = 30$) und den 
...
Einstichproben-T-Teststatistik, den korrespondierenden p-Wert und als alternative 
...
dass der Einstichproben-T-Test bei einer Stichprobengröße von $n = 30$ und einem
...
kurz die Bestimmung des Depressionszustandes mithilfe des *Beck Depression 
Inventory (BDI)*; konsultieren Sie dazu auch @beck1961. Erläutern Sie kurz das 
Einstichproben-T-Test-Modell und seine Designmatrixform. Konsultieren Sie dazu die 
entsprechenden Abschnitte in der ALM Vorlesung.
